...
not_modified = [
        ...
        # M20
        {"software_name": "SondeHub APRS-IS Gateway", "software_version": "f226ca1", "uploader_callsign": "SQ2IPS-2", "path": "WIDE1-1,WIDE2-1*,qAO,SQ2IPS-2", "time_received": "2025-10-21T20:11:20.722188Z", "payload_callsign": "SQ2IPS-11", "datetime": "2025-10-20T11:17:00.000000Z", "lat": 54.50580690212797, "lon": 18.538844815003444, "alt": 36479.0736, "comment": "C5S6R0T23P10002E-349V2176 M20 radiosonde test", "raw": "SQ2IPS-11>APZM20,WIDE1-1,WIDE2-1*,qAO,SQ2IPS-2:@201117z/2vc`S1DjO!!C/A=119682C5S6R0T23P10002E-349V2176 M20 radiosonde test", "aprs_tocall": "APZM20", "modulation": "APRS", "position": "54.50580690212797,18.538844815003444"},
]
...
class TestModified(unittest.TestCase):
    def test_modified_packet_processing(self):
        for payload in modified:
            self.assertTrue(modified_packets.is_modified_packet(payload), msg=payload)
    def test_not_modified_packet_processing(self):
        for payload in not_modified:
            self.assertFalse(modified_packets.is_modified_packet(payload), msg=payload)
